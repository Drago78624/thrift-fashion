<?php session_start();
    ...
    $stmt->execute();
    $ordersResult = $stmt->get_result();
    $num = mysqli_num_rows($ordersResult);

	if($num){
		$showOrders = true;
		$ordersRow = mysqli_fetch_all($ordersResult, MYSQLI_ASSOC);
		// print_r($ordersRow);
	}
...
<head>
    ...
    <title>Thrift Fashion - Dashboard</title>
            ...
            <div class="page-content">
            	<div class="dashboard">
					...
					<table class="table table-wishlist table-mobile">
						...
						<tbody>
							<?php foreach($ordersRow as $orders => $order):?>
							<tr>
								<td class="product-col">
									<div class="product">
										<figure class="product-media">
											<a href="#">
												<img src="<?php echo htmlspecialchars($order['order_img'])?>" alt="Product image">
											</a>
										</figure>

										<h3 class="product-title">
											<a href="#"><?php echo htmlspecialchars($order['order_name']) ?></a>
